      ...
      <div class="pe-5">
        <div class="text-start ">
          ...
          <p class="fs-6">
            ...
            over breakfast and help each other to optimize and develop their
        ...
        <div class="text-start">
          <p class="fs-5 headings fw-bolder">Accelerate your Personal Growth</p>
          <p class="fs-6">
            With valuable trainings and sessions, become a lifelong learner and
